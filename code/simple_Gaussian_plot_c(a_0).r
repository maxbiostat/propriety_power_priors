...
curve(l_a0_p, 0, 1, lwd = 2, lty = 2, col = 2,  ylab = "", xlab = expression(a[0]))
abline(h = 0 , lwd = 2 , lty = 3)
curve(l_a0, 0, 1, lwd = 2, add = TRUE)
points(adaptive.ca0.estimates$a0, adaptive.ca0.estimates$lc)
curve(l_a0_pp, 0, 1, lwd = 2, col = 3, add = TRUE)
